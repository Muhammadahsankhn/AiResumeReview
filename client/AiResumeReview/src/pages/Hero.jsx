...
const Hero = () => {
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8 bg-gray-900 text-white h-screen flex items-center">
      {/* Background decoration (glowing effect) */}
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          <h1 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl">
            Let AI Find Your <br /> Perfect Career Match
          </h1>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="#jobs" className="text-sm/6 font-semibold text-white">
